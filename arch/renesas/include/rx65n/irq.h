...
#define RX_RXI_IRQ_OFFSET	(0)                                 /* RxI0 */
#define RX_TXI_IRQ_OFFSET	(1)                                 /* TxI0 */
#define RX_ERI_IRQ_OFFSET	(2)  // (0) ?                       /* ERI0 */
...
# define RX65N_BUSERR_IRQ     (RX65N_BUSERR_IRQBASE) /* 16 */
# define RX65N_RAMERR_IRQBASE (RX65N_BUSERR_IRQBASE+2) /* Vector Number 17 reserved */



# define RX65N_RAMERR_IRQ     (RX65N_RAMERR_IRQBASE) /* 18 */
# define RX65N_FIFERR_IRQBASE (RX65N_RAMERR_IRQBASE+3) /* Vector Number 19,20 resreved */



# define RX65N_FIFERR_IRQ     (RX65N_FIFERR_IRQBASE) /* 21 */
# define RX65N_FRDYI_IRQBASE (RX65N_FIFERR_IRQBASE+2) /* 22 reserved */



# define RX65N_FRDYI_IRQ		(RX65N_FRDYI_IRQBASE) /* 23 */
# define RX65N_SWINT2_IRQBASE	(RX65N_FRDYI_IRQBASE+3)


#define RX65N_SWINT2_IRQ		(RX65N_SWINT2_IRQBASE)/* 26 */
#define RX65N_SWINT_IRQ			(RX65N_SWINT2_IRQBASE + 1)
#define RX65N_CMT0_IRQBASE		(RX65N_SWINT2_IRQBASE + 2)


#  define RX65N_CMI0_IRQ      RX65N_CMT0_IRQBASE/* 28 */
#  define RX65N_CMT1_IRQBASE  (RX65N_CMT0_IRQBASE + 1)



#  define RX65N_CMI1_IRQ       RX65N_CMT1_IRQBASE/* 29 */
#  define RX65N_CMTW0_IRQBASE  (RX65N_CMT1_IRQBASE + 1)



#  define RX65N_CMWI0_IRQ      RX65N_CMTW0_IRQBASE /* 30 */
#  define RX65N_CMTW1_IRQBASE  (RX65N_CMTW0_IRQBASE + 1)



#  define RX65N_CMWI1_IRQ       RX65N_CMTW1_IRQBASE/* 31 */
#  define RX65N_USB0_IRQBASE   (RX65N_CMTW1_IRQBASE + 3) /* 32,33 reserved */



#  define RX65N_D0FIFO0_IRQ    RX65N_USB0_IRQBASE /* 34 */
#  define RX65N_D1FIFO0_IRQ    (RX65N_USB0_IRQBASE + 1)
#  define RX65N_RSPI0_IRQBASE  (RX65N_USB0_IRQBASE + 3) /* 36,37 reserved */


#  define RX65N_SPRI0_IRQ      RX65N_RSPI0_IRQBASE /* 38 */
...
#  define RX65N_SPRI1_IRQ       RX65N_RSPI1_IRQBASE /* 40 */
#  define RX65N_SPTI1_IRQ       (RX65N_RSPI1_IRQBASE + 1)
#  define RX65N_QSPI_IRQBASE    (RX65N_RSPI1_IRQBASE + 2)



#  define RX65N_SPRI_IRQ        RX65N_QSPI_IRQBASE /* 42 */
#  define RX65N_SPTI_IRQ        (RX65N_QSPI_IRQBASE + 1)
#  define RX65N_SDHI_IRQBASE    (RX65N_QSPI_IRQBASE + 2)



#  define RX65N_SBFAI_IRQ        RX65N_SDHI_IRQBASE /* 44 */
#  define RX65N_MMCIF_IRQBASE    (RX65N_SDHI_IRQBASE + 1)



#  define RX65N_MBFAI_IRQ        RX65N_MMCIF_IRQBASE /* 45 */
#  define RX65N_RIIC1_IRQBASE    (RX65N_MMCIF_IRQBASE + 5)



#  define RX65N_RIIC1_RXI1_IRQ  (RX65N_RIIC1_IRQBASE + RX_RXI_IRQ_OFFSET) /* 50 */
#  define RX65N_RIIC1_TXI1_IRQ  (RX65N_RIIC1_IRQBASE + RX_TXI_IRQ_OFFSET)
#  define RX65N_RIIC0_IRQBASE   (RX65N_RIIC1_IRQBASE + 2)



#  define RX65N_RIIC0_RXI0_IRQ  (RX65N_RIIC0_IRQBASE + RX_RXI_IRQ_OFFSET) /* 52 */
#  define RX65N_RIIC0_TXI0_IRQ  (RX65N_RIIC0_IRQBASE + RX_TXI_IRQ_OFFSET)
#  define RX65N_RIIC2_IRQBASE   (RX65N_RIIC0_IRQBASE + 2)



#  define RX65N_RIIC2_RXI2_IRQ  (RX65N_RIIC2_IRQBASE + RX_RXI_IRQ_OFFSET)/* 54 */
...
#  define RX65N_RXI0_IRQ        (RX65N_SCI0_IRQBASE + RX_RXI_IRQ_OFFSET)/* 58 */
#  define RX65N_TXI0_IRQ        (RX65N_SCI0_IRQBASE + RX_TXI_IRQ_OFFSET)
#  define RX65N_SCI1_IRQBASE    (RX65N_SCI0_IRQBASE + 2)


#  define RX65N_RXI1_IRQ        (RX65N_SCI1_IRQBASE + RX_RXI_IRQ_OFFSET)/* 60 */
#  define RX65N_TXI1_IRQ        (RX65N_SCI1_IRQBASE + RX_TXI_IRQ_OFFSET)
#  define RX65N_SCI2_IRQBASE    (RX65N_SCI1_IRQBASE + 2)


#  define RX65N_RXI2_IRQ        (RX65N_SCI2_IRQBASE + RX_RXI_IRQ_OFFSET)/* 62 */
#  define RX65N_TXI2_IRQ        (RX65N_SCI2_IRQBASE + RX_TXI_IRQ_OFFSET)
#  define RX65N_ICU_IRQ_IRQBASE (RX65N_SCI2_IRQBASE + 2)



#  define RX65N_IRQ0_IRQ      (RX65N_ICU_IRQ_IRQBASE)/* 64 */
...
#  define RX65N_RTC_IRQBASE     (RX65N_USB0_R0_IRQBASE + 2)
